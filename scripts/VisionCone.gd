...
func _process(_delta: float) -> void:
	...
	visible = player != null and "signal_t" in player and player.signal_t > 0.0
	queue_redraw()
...
func _draw() -> void:
	...
	draw_colored_polygon(points, Color(0.4, 0.9, 1.0, 0.28))
	draw_polyline(points, Color(0.7, 1.0, 1.0, 0.7), 1.5, true)
